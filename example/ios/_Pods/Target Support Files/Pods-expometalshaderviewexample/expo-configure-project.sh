...
with_node --no-warnings --eval "require('expo-modules-autolinking')(process.argv.slice(1))" generate-package-list  --target "/Users/jam/Downloads/node/create-expo-module/expo-metal-shader-view/example/ios/Pods/Target Support Files/Pods-expometalshaderviewexample/ExpoModulesProvider.swift"
